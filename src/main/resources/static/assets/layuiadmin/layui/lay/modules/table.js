        ...
        return r.ie ? o.error("IE_NOT_SUPPORT_EXPORTS") : (n.href = "data:" + l + ";charset=utf-8,\ufeff" + encodeURIComponent(function () {
            ...
            return layui.each(t, function (t, l) {
                ...
                "object" == typeof e ? (layui.each(e, function (e, a) {
                    ...
                    var exportValue = typeof(a.templet) == 'function' ? a.templet(l) : l[a.field];
                    // html类型导出的时候转成文本
                    if(a.exportType == 'text') {
                        if(/<[^>]+>/g.test(exportValue)) {
                            var dom = document.createElement('div');
                            dom.innerHTML = exportValue;
                            exportValue = dom.innerText;
                        }
                    }
                    a.field && "normal" == a.type && !a.hide && (0 == t && i.push(a.title || ""), n.push(exportValue))
                }), a.push(n.join(","))
            }), i.join(",") + "\r\n" + a.join("\r\n")
