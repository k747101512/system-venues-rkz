...
;layui.define("layer", function (e) {
    ...
    p.prototype.config = {
        ...
        var n, o = this, l = o.config, r = o.elemFile[0], u = function () {
            ...
            layui.each(a, function (e, a) {
                ...
                r.append(l.field, a), layui.each(l.data, function (e, i) {
                    ...
                    error: function (i) {
                        var responseData = typeof(i.responseJSON) ? i.responseJSON : null;
                        if(responseData == null || typeof(responseData.msg) === 'undefined') {
                            responseData = null;
                            o.msg("请求上传接口出现异常")
                        }
                        n++, m(responseData, e), u()
                    }
                })
            })
        }, c = function () {
        ...
        }, m = function (responseData, e) {
            l.auto && (r.value = ""), "function" == typeof l.error && l.error(responseData, e || 0, function (e) {
                o.upload(e)
            })
        }, h = l.exts, v = function () {
            var i = [];
