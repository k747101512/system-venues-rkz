...
;layui.define("layer", function (e) {
    ...
    }), v.on("submit", r, d).on("click", "*[lay-submit]", d), e(l, f), v.on("click", "*[lay-form-button]", function() {
        var self = t(this);
        var layFilter = self.attr("lay-filter");
        layui.event.call(this, l, "button(" + layFilter + ")", {elem: this, form: v, field: {}})
    })
});