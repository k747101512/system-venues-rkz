...
layui.define('view', function (exports) {
    ...
    $body.on('click', '*[lay-href]', function () {
        ...
        var router = layui.router();
        var openType = othis.attr('lay-open-type');
        var baseUrl = document.getElementsByTagName('base')[0].href;
        baseUrl = (typeof (baseUrl) == 'undefined' ? '' : baseUrl.substring(0, baseUrl.lastIndexOf("/")));
        ...
        if (openType == 1) {
            ...
            topLayui.index.openTabsPage(top.restAjax.path('{baseUrl}{href}', [baseUrl, href]), text || othis.text());
        } else if (openType == 2) {
            top.dialog.open({
                url: top.restAjax.path('{baseUrl}{href}', [baseUrl, href]),
                title: text || othis.text(),
                width: '1000px',
                height: '600px',
                onClose: function () {
                }
            ...
            window.open(top.restAjax.path('{baseUrl}{href}', [baseUrl, href]), "_blank");
        } else if (openType == 4) {
            window.open(top.restAjax.path('{baseUrl}{href}', [baseUrl, href]), '_self');
        }
    });
