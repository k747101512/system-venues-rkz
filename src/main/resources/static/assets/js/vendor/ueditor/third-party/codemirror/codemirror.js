...
var CodeMirror = (function() {
    ...
    CodeMirror.defaults = {
        value: "",
        mode: null,
        theme: "static.default",
        indentUnit: 2,
        indentWithTabs: false,
        tabSize: 4,
        keyMap: "static.default",
        extraKeys: null,
        electricChars: true,
        onKeyEvent: null,
        lineWrapping: false,
    ...
    keyMap["static.default"] = mac ? keyMap.macDefault : keyMap.pcDefault;
    keyMap.emacsy = {
...
CodeMirror.defineMode("javascript", function(config, parserConfig) {
    ...
    var keywords = function(){
        ...
        return {
            ...
            "for": kw("for"), "switch": kw("switch"), "case": kw("case"), "default": kw("static.default"),
    ...
    function statement(type) {
        ...
        if (type == "static.default") return cont(expect(":"));
