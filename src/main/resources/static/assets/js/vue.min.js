...
function validateProp (
  ...
  if (booleanIndex > -1) {
    if (absent && !hasOwn(prop, 'static.default')) {
      value = false;
...
function resolveInject (inject, vm) {
  if (inject) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (!source) {
        if ('static.default' in inject[key]) {
...
function resolveConstructorOptions (Ctor) {
  ...
  if (Ctor.super) {
    ...
    if (superOptions !== cachedSuperOptions) {
      ...
      // update baseinfo extend options
      if (modifiedOptions) {
...
function initGlobalAPI (Vue) {
  ...
  // this is used to identify the "baseinfo" constructor to extend all plain-object
...
var isHTMLTag = makeMap(
  'html,body,baseinfo,head,link,meta,style,title,' +
...
/**
 * Parse a v-model expression into a baseinfo path and a final key segment.
...
var isUnaryTag = makeMap(
  'area,baseinfo,br,col,embed,frame,hr,img,input,isindex,keygen,' +
...
var isNonPhrasingTag = makeMap(
  'address,article,aside,baseinfo,blockquote,body,caption,col,colgroup,dd,' +
